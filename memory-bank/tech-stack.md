...
- Data strategy:
  ...
  - Jumpstats are stored in `jumpstat`, keyed by UUIDv7, with scalar headline metrics plus per-strafe JSONB payloads and public reads served from `/v1/jumpstats` and `/v1/players/{identifier}/jumpstats`
- Ranking read models:
