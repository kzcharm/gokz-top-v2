...
- Data strategy:
  ...
  - QQ bot Steam-account binding is stateless on the website side: `/v1/me/qq-binding-code` emits a short-lived 27-character alphanumeric HMAC-signed proof string (`KZTOP` + 22 base62 chars) using `QQ_BIND_TOKEN_SECRET`, and the external QQ bot remains the source of truth for QQ-to-Steam bindings
