...
class Settings(BaseSettings):
    ...
    RECORD_PB_POINTS_TASK_STALE_AFTER_SECONDS: int = 86_400
    RECORD_PB_POINTS_TASK_HOUR_UTC: int = 3
    LEADERBOARD_PLAYER_TASK_STALE_AFTER_SECONDS: int = 86_400
    LEADERBOARD_PLAYER_TASK_HOUR_UTC: int = 4
    ...
    RUN_RECORD_PB_POINTS_TASK_RUNNER_IN_APP: bool = True
    RUN_LEADERBOARD_PLAYER_TASK_RUNNER_IN_APP: bool = True
    LOG_LEVEL: str = "INFO"
