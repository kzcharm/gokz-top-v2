...
export const AdminAppSettingsPublicSchema = {
    properties: {
        community_links_location: {
            '$ref': '#/components/schemas/CommunityLinksLocation'
        },
        globalapi_records_sync_enabled: {
            type: 'boolean',
            title: 'Globalapi Records Sync Enabled'
        }
    },
    type: 'object',
    required: ['community_links_location', 'globalapi_records_sync_enabled'],
    title: 'AdminAppSettingsPublic'
} as const;
