...
export class PlayersService {
    ...
    /**
     * Read Player Daily Activity Stat
     * @param data The data for the request.
     * @param data.identifier
     * @returns PlayerDailyActivityStatPublic Successful Response
     * @throws ApiError
     */
    public static readPlayerDailyActivityStat(data: PlayersReadPlayerDailyActivityStatData): CancelablePromise<PlayersReadPlayerDailyActivityStatResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/v1/players/{identifier}/stats/daily_activity',
            path: {
                identifier: data.identifier
            },
            errors: {
