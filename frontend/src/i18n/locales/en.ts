export const en = {
  ...
  polls: {
    ...
    unableToLoad: "Unable to load poll",
    unableToLoadDescription: "This poll may no longer be available.",
  ...
  notifications: {
    ...
    events: {
      profileLike: "{{actor}} liked your profile.",
      profileLikeAction: "liked your profile.",
      profileComment: "{{actor}} commented on your profile.",
      profileCommentAction: "commented on your profile.",
      playerFollow: "{{actor}} followed you.",
      playerFollowAction: "followed you.",
      wrBeaten: "{{actor}} beat your WR on {{map}}.",
      wrBeatenAction: "beat your WR on {{map}}.",
  ...
  profile: {
    ...
    stats: {
      ...
      recordsMetric: "Records",
      hoursMetric: "Hours",
      empty: "No record time found for this view.",
      mapsEmpty: "No map record data found for this view.",
      loadFailed: "Failed to load stats.",
      ariaLabel: "Most played server chart for {{view}}",
      mapsAriaLabel: "Most played maps chart for {{view}}",
      tooltipHours: "Playtime: {{hours}} {{percent}}%",
      tooltipRecords_one: "{{count}} record",
      tooltipRecords_other: "{{count}} records",
  ...
  maps: {
    ...
    mapperPlaceholder: "Search mappers...",
    mapperAria: "Filter maps by mapper",
    clearMapper: "Clear selected mapper",
    validated: "Validated",
    invalid: "Invalid",
    validatedStatusAria: "Showing validated maps. Click to show invalid maps.",
    invalidStatusAria: "Showing invalid maps. Click to show validated maps.",
    showFilters: "Filters",
    ...
    filterMin: "Min",
    filterMax: "Max",
    invalidWrTime: "Enter a WR time in seconds or M:SS.mmm format.",
    invalidDate: "Enter a valid date.",
    invalidNumber: "Enter a non-negative number.",
    ...
    minimumTierAria: "Minimum map tier",
    maximumTierAria: "Maximum map tier",
    withBonus: "With Bonus",
    withBonusAria: "Show only maps with bonuses",
    downloadDialog: {
      button: "Download",
      title: "Download Maps",
      description: "Download or update maps with one command.",
  ...
  compare: {
    ...
    description:
      "Compare scoped rankings, map progression, and main-stage PBs.",
    player1: "Player 1",
    player2: "Player 2",
    player1Search: "Search player 1",
    player2Search: "Search player 2",
    clearPlayer1: "Clear player 1",
    clearPlayer2: "Clear player 2",
    swapPlayers: "Swap players",
    duplicatePlayers: "Choose two different players.",
    selectBoth: "Select two players to start comparing.",
    loading: "Loading comparison...",
    loadFailed: "Unable to load this comparison.",
    ...
    progressionDescription: "Main-map completion percentage by tier.",
    progressionAria:
      "Tier completion comparison between {{player1}} and {{player2}}",
    tier: "Tier",
    runs: "Runs",
    onlyBoth: "Only maps finished by both",
    noRuns: "No main-stage PBs match this view.",
  ...
  reactions: {
    ...
    loadError: "Unable to load reactions.",
    empty: "Nobody has reacted yet.",
    showAllReactors: "Show all {{count}} reactors",
    showLess: "Show less",
    toggle: "Toggle {{emoji}} reaction",
    reactorsHint:
      "{{emoji}} reactors open after a short hover or on right-click",
    reactors: "Reactions",
    reactorCount: "{{count}} player reacted",
    reactorCount_other: "{{count}} players reacted",
    updateError: "Your reaction could not be saved.",
    add: "Add reaction",
    react: "React",
    choose: "Choose a reaction",
    signInHint: "Choose an emoji to sign in with Steam and return here.",
    catalogError: "Unable to load the emoji picker.",
  },
  bans: {
    title: "Bans",
    searchAria: "Search players",
